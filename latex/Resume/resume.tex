...
\href{http://www.sncorp.com}{
     ...
     \begin{outerlist}
         ...
         \begin{innerlist}
            \item Long-Wave Infra-Red, Wide Area Motion Imagery (WAMI) Platform, DoD program.
            \item Lead a team of 6 Systems Engineers, Scientists, and Program Coordinators.
            \item Responsible for the integration, testing, and fielding of the platform.
            \begin{innerlist}
                \item Developed the test plan and test procedures to verify specific and targeted objectives. 
                \item Coordinated and led flight test activities to ensure high-priority objectives were met. 
                \item I have spent lots of time in aircraft hangars ensuring that the system works prior to high-risk test activities. 
            \end{innerlist}
            \item I am responsible for the development, tracking, and maintenance of all requirements.
            \begin{innerlist}
                    \item Developed many of the verification procedures for system and software requirements. 
                    \item Verified all requirements per required methodology (ex:  flight tests, lab tests, and analysis/inspection reports).
                    \item Verified derived requirements through subcontractors via similar methods. 
            \end{innerlist}
            \item I still write lots of code, as well as train others to write code, to help the Systems Engineering team to more efficiently achieve objectives.
            \item I spend 80\% of my time putting out fires. 
         \end{innerlist}
