...
\href{http://www.sncorp.com}{
     ...
     \item Relevant Tasks:
     \begin{innerlist}
         \item Responsible for Information Assurance and compliance with DoD Security Technical Implementation Guides (STIGs) for Windows systems.
         \item Responsible for Configuration Management of all Windows systems.
         \item Assisting with Image Processing and Algorithm Development.
         \item Assisting with development of technical data for project software and hardware.
         \item Assisting with training of technician personnel for project software and hardware.\\
     \end{innerlist}
     \end{outerlist}
...
\item{\textbf{Software Experience}:} 
   ...
   \item GIS : GDAL, GeoServer, OpenLayers, Google Earth Enterprise
   \item Misc : Qt
   \end{outerlist}

\item{\textbf{System Administration}:} Secure Configuration Management, software build systems, network infrastructure and troubleshooting.
