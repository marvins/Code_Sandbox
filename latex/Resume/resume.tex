...
& \textsl{StackExchange: msmith81886}\\
\end{tabular}
...
\href{http://www.sncorp.com}{
     ...
     \begin{outerlist}
     \item Assisting on the software development and 
     ...
     \begin{innerlist}
         ...
         \item Implemented Information Assurance procedures and ensured compliance with DoD Security Technical Implementation Guides (STIGs) for Windows and Linux systems on our project.
         \item Assisted with system configuration and network troubleshooting of Linux systems.
...
\item{\textbf{Software Experience}:} 
   ...
   \item Numerical Computation : Numerical Python, FLANN, LibSVM
   \item GIS : GDAL, GeoServer, OpenLayers, Google Earth Enterprise deployments
   \item Misc : Qt
   \end{outerlist}

\item{\textbf{System Administration}:} Secure Configuration Management deployment (git, svn, Artifactory), constructing software build systems (Jenkins), and computer networking.
...
\item{\textbf{Math}:} Multivariable Calculus, Linear Algebra, some Signal Processing
