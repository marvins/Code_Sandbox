...
\href{http://www.sncorp.com}{
     ...
     \begin{innerlist}
         ...
         \item Assisted with system integration and troubleshooting of Windows and Linux systems.
         \item Assisted with development of technical data for project software and hardware.
...
\item{\textbf{Software Experience}:} 
   ...
   \item Python : pyqt, matplotlib, SciPy, NumPy, SymPy
   \item Misc : C++ Template Metaprogramming, Qt, MPI, some Cuda
   \end{outerlist}
...
Reno, NV 
\begin{outerlist}
\item[] \href{http://www.unr.edu/degrees/business-administration/mba}
        {Master of Business Administration}
        (Expected Graduation: May 2016)(Just starting)
        \begin{innerlist}
        \item Interests: Project/Engineering Management
        \item Completed Courses:  Introduction to Patent Law\\
        \end{innerlist}
\end{outerlist}
