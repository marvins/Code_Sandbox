...
\href{http://www.sncorp.com}{
     ...
     \begin{outerlist}
         ...
         \begin{innerlist}
            ...
            \item Significant test experience.  I've written test plans, test cards, and mapped test activities against system requirements.  I can boil down a complex activity such as measuring ground-location-accuracy of an ortho-image into a process test personnel can replicate and sign off on.
         ...
         \end{innerlist}
         \item Active DOD security clearance.\\
     \end{outerlist}
