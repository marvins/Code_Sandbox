...
\item{\textbf{Software Experience}:} 
   ...
   \item GIS : GDAL, GeoServer, libLAS (lidar), GeographicLib, OpenLayers, Google Earth Enterprise deployments
   \item Distributed Computing : MPI, IBVerbs, RDMA, BSD Sockets
...
Prateek Joshi\\
``OpenCV with Python By Example", Packt Publishing, October 2015\\
\href{https://www.packtpub.com/application-development/opencv-python-example}{link}

\item Technical Reviewer\\
Garcia, Aranda, Suarez, Tercero,\\
``Learning Image Processing with OpenCV", Packt Publishing, March 2015\\
