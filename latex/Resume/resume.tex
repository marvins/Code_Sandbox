...
\href{http://www.sncorp.com}{
     \textbf{Senior Software Engineer, ISS Division}}\\
     ...
     \item Tasks:
     \begin{innerlist}
         \item Currently working on image processing for wide-area surveillance systems.  
               Primary focuses are in remote sensing, high-performance computing, camera calibration, 
               orthographic rectification, and photogrammetry. 
...
\item{\textbf{Software Experience}:} 
   ...
   \item GIS : GDAL, GeoServer, libLAS (lidar), and GeographicLib
