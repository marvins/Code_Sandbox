...
\href{http://www.sncorp.com}{
     ...
     \begin{outerlist}
         \item \textbf{SEIT Lead  (Systems Engineering, Integration, and Test), 2021 - Present}\\
         \begin{innerlist}
            \item Long-Wave IR, Wide Area Surveillance DoD program.
            \item Responsible for the integration, testing, and final delivery of the system.
            \item Responsible for the development, tracking, and maintenance of all requirements.
            \item I recently took the position in Fall of 2021 and am taking over responsiblities during the integration phase. \\
         \end{innerlist}
         ...
         \item I am currently working on a DOD TS-SCI clearance (Waiting on interim). \\
     \end{outerlist}
\clearpage
