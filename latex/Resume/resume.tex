...
\href{http://www.sncorp.com}{
     ...
     \begin{outerlist}
         \item Currently working on image processing applications for wide-area surveillance programs.  
         \item Primary fields of expertise are in remote sensing and high-performance computing.  
         \item Some examples of specific tasks
               I have performed include designing ortho-rendering algorithms on multi-node clusters, 
               transferring terabytes of data over high speed networks (10 Gig Fiber, 40 GigE, and IB), 
               creating and writing GIS data to various DOD formats (still imagery, motion imagery, vector data) 
               using open-source and proprietary APIs, and building camera model equations for different sensors.  
         \item I have also developed much of the build, 
               unit-test, continuous-integration, and deployment infrastructure required.
