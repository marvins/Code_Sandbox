...
\href{http://www.nv.ngb.army.mil/air/index.cfm}
     ...
     August 2006 - February 2013 (Currently Inactive)
     \begin{outerlist}
...
\item[] Masters of Science, 
        \href{http://www.cse.unr.edu/}{Computer Science (Accelerated M.S./B.S. Program)}\\
             (expected graduation date: May 2014)
        \begin{innerlist}
        \item Adviser:
              \href{http://www.unr.edu/~bebis/}
                   {Dr. George Bebis}
        \item Research Topic: Human Face Sketch Recognition using Wavelets.
        \item Courses Completed: Machine Learning, Computer Graphics\\
        \end{innerlist}
\end{outerlist}
...
\item{\textbf{Programming Languages/Tools}:} C++, Java, Python, C\#, Matlab, \LaTeX{}, Windows/Linux Scripting, some Haskell

\item{\textbf{Software Experience}:} 
   \begin{outerlist}
   \item Computer Vision and Image Processing : OpenCV, Matlab, NASA Vision Workbench
   \item Numerical Computation : Numerical Python, Matlab, FLANN, LibSVM
   \item Geographic Information Systems and Satellite Imagery : GDAL
   \end{outerlist}
...
%**************************************************************
\section{Hobbies}
Yoga, swimming, collecting antique instruments
