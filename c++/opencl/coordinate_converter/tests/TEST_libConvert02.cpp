...
/***********************************************************/
TEST( OpenCL_Convert_02, Convert_Geographic_WGS84_To_UTM )
{
    ...
    // Create Converter
    auto converter_config = std::make_shared<OpenCL_Converter_Config_02>( device_type );
    OpenCL_Converter_02 converter(converter_config);
